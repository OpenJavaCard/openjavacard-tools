...
public class CapImplementedInterfaceInfo extends CapStructure {
    ...
    private CapClassRef mInterface;

    private int mMethodCount;
    private int[] mMethodIndices;

    public void read(CapStructureReader reader) throws IOException {
        mInterface = reader.readClassRef();
        mMethodCount = reader.readU1();
        mMethodIndices = reader.readU1Array(mMethodCount);
    }
